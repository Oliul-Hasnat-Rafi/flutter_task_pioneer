...
import 'package:flutter_task/core/base/widgets/custom_animated_size.dart';
  ...
  Widget build(BuildContext context) {
    return CustomAnimatedSize(
      child: Container(
        ...
        decoration: BoxDecoration(borderRadius: widget.borderRadius, border: widget.border, boxShadow: widget.boxShadow, color: widget.boxShadow == null ? null : Colors.white),
        child: Material(
          ...
          child: InkWell(
            ...
            child: Container(
              ...
              constraints: widget.constraints ?? const BoxConstraints(minHeight: 48),
              child: Column(
