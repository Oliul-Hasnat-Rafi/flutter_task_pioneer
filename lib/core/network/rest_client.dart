...
class RestClient {
  ...
  void _dioError(DioError error) {
    ...
    switch (error.type) {
      case DioErrorType.cancel:
        throw RequestCancelledException(001, AppStrings.defaultErrorMessage);
      case DioErrorType.connectTimeout:
        throw RequestTimeoutException(
          ErrorModel(message: AppStrings.defaultErrorMessage),
        );
      ...
      case DioErrorType.receiveTimeout:
        throw ReceiveTimeoutException(004, AppStrings.couldNotConnectToServer);
  ...
  void _networkException(
    ...
    switch (statusCode) {
      ...
      default:
        throw DefaultException(
          ErrorModel(statusCode: 500, message: AppStrings.defaultErrorMessage),
        );
    }
  }
